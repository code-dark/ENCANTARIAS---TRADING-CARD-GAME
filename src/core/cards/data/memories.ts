...
export const memories: MemoryCard[] = [
...

  {
    ...
    type: 'Memory',
    name: 'Shared: A Versão de Quem Chegou Depois',
    memoryState: 'Shared',
...

  {
    ...
    type: 'Memory',
    name: 'Corporate: Laudo sobre o Manancial',
    memoryState: 'Corporate',
...

  {
    ...
    type: 'Memory',
    name: 'Media: A Reportagem do Centenário',
    memoryState: 'Media',
    discovery: { via: ['explore'], escuta: 1 },
...

  {
    ...
    type: 'Memory',
    name: 'Corporate: Inventário de Bens',
    memoryState: 'Corporate',
    discovery: { via: ['explore'], escuta: 4 },
...

  {
    ...
    type: 'Memory',
    name: 'Corporate: Ata de Restauro',
    memoryState: 'Corporate',
    discovery: { via: ['explore'], escuta: 4 },
...

  {
    ...
    type: 'Memory',
    name: 'Roots: O Que a Escada Segura',
    memoryState: 'Roots',
    discovery: { via: ['explore'], escuta: 4 },
...

  {
    ...
    type: 'Memory',
    name: 'Corporate: Catálogo de Feira',
    memoryState: 'Corporate',
    discovery: { via: ['explore'], escuta: 4 },
...

  {
    ...
    type: 'Memory',
    name: 'Media: O Selo de Autenticidade',
    memoryState: 'Media',
    discovery: { via: ['explore'], escuta: 1 },
...

  {
    ...
    type: 'Memory',
    name: 'Shared: A História Que Mudou de Boca',
    memoryState: 'Shared',
    discovery: { via: ['explore'], escuta: 2 },
...

  {
    ...
    type: 'Memory',
    name: 'Corporate: Livro de Registros',
    memoryState: 'Corporate',
    discovery: { via: ['explore'], escuta: 4 },
